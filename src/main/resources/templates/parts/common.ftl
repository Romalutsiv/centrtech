      ...
      <div class="collapse navbar-collapse" id="navbarsExample07">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"><b>CRM</b></a>
              </li>
              <li class="nav-item">
